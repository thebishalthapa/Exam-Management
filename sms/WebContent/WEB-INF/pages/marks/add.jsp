...
<div class="fluid-container" id="dashboardcontainer"
			...
			<c:forEach var="strow" items="${studentList}">
				<tr>
					...
					<td><a type="button" class="btn btn-primary glyphicon glyphicon-plus" id="submit${count}"
						onClick="rankStudent(${count})" >Add </a>
	...
	<br>
	<div class="pull-left">
		 <a href="${pageContext.request.contextPath }/marks/marks_sheet?classId=${studentClass.classId}&examId=${exam.examId }" class="btn btn-success 	glyphicon glyphicon-print">
							 Download Excel  </a> 
	</div>
