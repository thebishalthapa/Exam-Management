		...
		<tbody>
			<c:forEach var="strow" items="${studentList}">
				<tr>
					...
					<td>${strow.roll}</td>
					<td><a href="${pageContext.request.contextPath }/report/print?examId=${exam.examId }&classId=${studentClass.classId}&studentId=${strow.studentId }" class="btn btn-success 	glyphicon glyphicon-print">
								PRINT </a> 
				   </td>
				</tr>
			</c:forEach>
